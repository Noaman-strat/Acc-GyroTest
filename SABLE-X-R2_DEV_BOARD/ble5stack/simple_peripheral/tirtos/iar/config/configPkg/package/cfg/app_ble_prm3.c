 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = D:/mie/Work/ti/simplelink_cc2640r2_sdk_1_40_00_45/examples/rtos/SABLE-X-R2_DEV_BOARD/ble5stack/simple_peripheral/tirtos/iar/config/configPkg/package/cfg/app_ble_prm3");
